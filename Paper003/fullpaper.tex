...
The performance of the proposed reinforcement learning control algorithm was evaluted in one example through numerical simulation. To demonstrate the propsed control algorithm, a three-story building with a single MR damper was considered. The MR damper was installed in the first floor, as shown in \ref{structure}. The mass $M$, dampering $Cs$ and stiffness $Ks$ matrices are as follows:
